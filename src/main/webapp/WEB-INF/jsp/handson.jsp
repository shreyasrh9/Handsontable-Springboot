...
<body class="Welcome-Screen" style="font-family: Open-Sans;overflow-y:scroll;font-size:20px  
    ...
    <h1 style="position:absolute">Handson Table</h1>
		...
		<button type="button" class="btn btn-success btn-sm" name="dump2">Upload Data 
				</button>
		<div class="col-xs-12" style="margin-top: 15px; padding: 15px;">

			<form:form id="form_bulkUpload" action="uploadBulkData"
				method="post">
				<div class="form-group">
					<div class="row">
						...
						<div class="col-xs-6">
							...
							<textarea class="form-control" rows="5" id="data_compressed" name="bulkData"
								style="margin-top: 5px; margin-bottom: 10px;"></textarea>
						</div>
